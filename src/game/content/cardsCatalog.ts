...
export const cardCatalog: CardDefinition[] = [
  ...
  },
  {
    id: 'flak-barrage',
    name: 'Flak Barrage',
    description: '+1 Flak Cannon level.',
    rarity: 'uncommon',
    tags: ['weapon', 'flak', 'assault'],
    cost: 60,
    maxStacks: 2,
    unlockRound: 2,
    shopWeight: 0.86,
    dropWeight: 0.7,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Flak Cannon', amount: 1 }]
  },
  {
    id: 'mine-lattice',
    name: 'Mine Lattice',
    description: '+1 Proximity Mines level.',
    rarity: 'uncommon',
    tags: ['weapon', 'mine', 'utility'],
    cost: 60,
    maxStacks: 2,
    unlockRound: 2,
    shopWeight: 0.84,
    dropWeight: 0.68,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Proximity Mines', amount: 1 }]
  },
  {
    id: 'graviton-core',
    name: 'Graviton Core',
    description: '+1 Gravity Bomb level.',
    rarity: 'uncommon',
    tags: ['weapon', 'gravity', 'precision'],
    cost: 62,
    maxStacks: 2,
    unlockRound: 2,
    shopWeight: 0.82,
    dropWeight: 0.66,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Gravity Bomb', amount: 1 }]
  },
  {
    id: 'napalm-canisters',
    name: 'Napalm Canisters',
    description: '+1 Thermal Napalm Pods level.',
    rarity: 'uncommon',
    tags: ['weapon', 'napalm', 'assault'],
    cost: 62,
    maxStacks: 2,
    unlockRound: 2,
    shopWeight: 0.8,
    dropWeight: 0.64,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Thermal Napalm Pods', amount: 1 }]
  },
  {
    id: 'tesla-coil',
    name: 'Tesla Coil',
    description: '+1 Tesla Arc level.',
    rarity: 'uncommon',
    tags: ['weapon', 'tesla', 'precision'],
    cost: 62,
    maxStacks: 2,
    unlockRound: 2,
    shopWeight: 0.8,
    dropWeight: 0.64,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Tesla Arc', amount: 1 }]
  },
  {
    id: 'chain-conduit',
    name: 'Chain Conduit',
    description: '+1 Chain Laser level.',
    rarity: 'uncommon',
    tags: ['weapon', 'chain-laser', 'precision'],
    cost: 64,
    maxStacks: 2,
    unlockRound: 2,
    shopWeight: 0.78,
    dropWeight: 0.62,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Chain Laser', amount: 1 }]
  },
  {
    id: 'ion-capacitor',
    name: 'Ion Capacitor',
    description: '+1 Ion Burst level.',
    rarity: 'uncommon',
    tags: ['weapon', 'ion', 'assault'],
    cost: 60,
    maxStacks: 2,
    unlockRound: 2,
    shopWeight: 0.84,
    dropWeight: 0.68,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Ion Burst', amount: 1 }]
  },
  {
    id: 'spread-chamber',
    name: 'Spread Chamber',
    description: '+1 Spread Shot level.',
    rarity: 'uncommon',
    tags: ['weapon', 'spread', 'assault'],
    cost: 58,
    maxStacks: 2,
    unlockRound: 2,
    shopWeight: 0.86,
    dropWeight: 0.7,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Spread Shot', amount: 1 }]
  },
  {
    id: 'helix-gyro',
    name: 'Helix Gyro',
    description: '+1 Helix Blaster level.',
    rarity: 'uncommon',
    tags: ['weapon', 'helix', 'precision'],
    cost: 62,
    maxStacks: 2,
    unlockRound: 2,
    shopWeight: 0.82,
    dropWeight: 0.66,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Helix Blaster', amount: 1 }]
  },
  {
    id: 'orbital-relay',
    name: 'Orbital Relay',
    description: '+1 Orbital Drones level.',
    rarity: 'rare',
    tags: ['weapon', 'orbital', 'drone'],
    cost: 78,
    maxStacks: 2,
    unlockRound: 3,
    shopWeight: 0.52,
    dropWeight: 0.42,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Orbital Drones', amount: 1 }]
  },
  {
    id: 'disc-accelerators',
    name: 'Disc Accelerators',
    description: '+1 Rotary Disc Launcher level.',
    rarity: 'rare',
    tags: ['weapon', 'disc', 'assault'],
    cost: 78,
    maxStacks: 2,
    unlockRound: 3,
    shopWeight: 0.5,
    dropWeight: 0.4,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Rotary Disc Launcher', amount: 1 }]
  },
  {
    id: 'shield-projector-matrix',
    name: 'Shield Projector Matrix',
    description: '+1 Energy Shield Projector level.',
    rarity: 'rare',
    tags: ['weapon', 'shield-proj', 'defense'],
    cost: 76,
    maxStacks: 2,
    unlockRound: 3,
    shopWeight: 0.54,
    dropWeight: 0.44,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Energy Shield Projector', amount: 1 }]
  },
  {
    id: 'reflector-harmoniser',
    name: 'Reflector Harmoniser',
    description: '+1 Reflector Pulse level.',
    rarity: 'rare',
    tags: ['weapon', 'reflector', 'defense'],
    cost: 76,
    maxStacks: 2,
    unlockRound: 3,
    shopWeight: 0.54,
    dropWeight: 0.44,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Reflector Pulse', amount: 1 }]
  },
  {
    id: 'chrono-emitter',
    name: 'Chrono Emitter',
    description: '+1 Time Distortion Pulse level.',
    rarity: 'rare',
    tags: ['weapon', 'time', 'precision'],
    cost: 80,
    maxStacks: 2,
    unlockRound: 3,
    shopWeight: 0.48,
    dropWeight: 0.38,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Time Distortion Pulse', amount: 1 }]
  },
  {
    id: 'drone-combat-uplink',
    name: 'Drone Combat Uplink',
    description: '+1 Attack Drone level.',
    rarity: 'rare',
    tags: ['weapon', 'attack-drone', 'drone'],
    cost: 78,
    maxStacks: 2,
    unlockRound: 3,
    shopWeight: 0.5,
    dropWeight: 0.4,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Attack Drone', amount: 1 }]
  },
  {
    id: 'interceptor-matrix',
    name: 'Interceptor Matrix',
    description: '+1 Interceptor Drone level.',
    rarity: 'rare',
    tags: ['weapon', 'interceptor-drone', 'drone'],
    cost: 80,
    maxStacks: 2,
    unlockRound: 3,
    shopWeight: 0.48,
    dropWeight: 0.38,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Interceptor Drone', amount: 1 }]
  },
  {
    id: 'salvage-uplink',
    name: 'Salvage Uplink',
    description: '+1 Salvage Drone level.',
    rarity: 'rare',
    tags: ['weapon', 'salvage-drone', 'drone'],
    cost: 76,
    maxStacks: 2,
    unlockRound: 3,
    shopWeight: 0.52,
    dropWeight: 0.42,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Salvage Drone', amount: 1 }]
  },
  {
    id: 'prism-array',
    name: 'Prism Array',
    description: '+1 Prism Splitter level.',
    rarity: 'rare',
    tags: ['weapon', 'prism', 'precision'],
    cost: 78,
    maxStacks: 2,
    unlockRound: 3,
    shopWeight: 0.5,
    dropWeight: 0.4,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Prism Splitter', amount: 1 }]
  },
  {
    id: 'polygon-forge',
    name: 'Polygon Forge',
    description: '+1 Polygon Shredder level.',
    rarity: 'rare',
    tags: ['weapon', 'polygon', 'assault'],
    cost: 80,
    maxStacks: 2,
    unlockRound: 3,
    shopWeight: 0.48,
    dropWeight: 0.38,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Polygon Shredder', amount: 1 }]
  },
  {
    id: 'vector-lens',
    name: 'Vector Lens',
    description: '+1 Vector Beam level.',
    rarity: 'rare',
    tags: ['weapon', 'vector', 'precision'],
    cost: 80,
    maxStacks: 2,
    unlockRound: 3,
    shopWeight: 0.48,
    dropWeight: 0.38,
    effects: [{ kind: 'weaponLevel', weaponMode: 'Vector Beam', amount: 1 }]
  },
  {
    id: 'bastion-core',
    name: 'Bastion Core',
